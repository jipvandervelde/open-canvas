---
name: surfaces
description: Surface polish details — nested border-radius math, optical alignment of icons and text, layered box-shadows, image outlines, hit-area expansion. The geometry layer that separates "it works" from "it looks correct." Use for any screen with cards, buttons, images, or layered surfaces where pixel-level rightness matters.
scope: sub-agent
triggers: border-radius, border radius, optical alignment, box-shadow, box shadow, shadow, image outline, hit area, tap target, surface, elevation, stacked shadow, layered shadow, rounded corner, inset border, nested radius, ring
---
