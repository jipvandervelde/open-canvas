...
name: forms-controls
scope: sub-agent
triggers: form, input, sign in, sign-in, signin, login, log in, signup, sign up, register, checkout, payment, password, search, filter, settings, profile edit, edit profile, text area, textarea, compose, message
---
