---
name: animations
description: Animation fundamentals — easing curves, spring physics, duration tiers, reduced-motion gating, page transitions, enter/exit patterns. The floor every animated element should respect. Use for any screen with page/section-level motion, transitions, or onboarding reveals.
scope: sub-agent
triggers: easing, duration, reduced-motion, prefers-reduced-motion, cubic-bezier, ease-out, ease-in-out, ease-in, spring, damping, keyframe, timing, page transition, page-transition, enter, exit, fade, slide, onboarding, reveal, splash, welcome, intro, celebrat
---
...
**Scope of this file**: fundamentals. Easing, duration, spring physics, reduced-motion. The how-long / how-smoothly / for-whom layer. For element-level micro-patterns (scale-on-press, stagger, interruptibility, icon animations), see `make-interfaces-feel-better/animations`.
